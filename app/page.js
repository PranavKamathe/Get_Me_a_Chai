...
export default function Home() {
 ...
 from-purple-600 to-blue-500 hover:to-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-base text-sm px-4 py-2.5 text-center leading-5"
            >
              Purple to Blue
            </button>
          </Link>
      ...
      <div className="text-white container mx-auto pb-32 pt-14 flex flex-col items-center justify-center">
        ...
        <div className="w-[90%] h-[40vh] md:w-[50%] md:h-[40vh] lg:w-[50%] lg:h-[40vh] xl:w-[50%] xl:h-[40vh]">
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/AwRfvtCpdiQ?si=zqI8PG7G4SuBTIpj"
